...
<body>
  ...
  */
  ...
  if (file_exists( "/var/www/electrop/data/www/zapchasti-kotla.ru/export/" . IMPORT_FILE_NAME )) 
  {
      $smpl_xml = simplexml_load_file( "/var/www/electrop/data/www/zapchasti-kotla.ru/export/" . IMPORT_FILE_NAME );
